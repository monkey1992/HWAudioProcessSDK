...
#include "com_huawu_fivesmart_audio_apm_Apm.h"
...
{
    std::string hello = "Hello from hwapmsdk!!!";
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_high_1pass_1filter_1enable
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_aec_1enable
        (JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_aec_1clock_1drift_1compensation_1enable
(JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_aec_1set_1suppression_1level
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_aecm_1enable
        (JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_aecm_1set_1suppression_1level
        (JNIEnv *env, jobject thiz, jint level){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_ns_1set_1level
(JNIEnv *env, jobject thiz, jint level){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_ns_1enable
(JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_agc_1set_1analog_1level_1limits
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_agc_1set_1mode
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_agc_1set_1target_1level_1dbfs
  (JNIEnv *env, jobject thiz, jint level){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_agc_1set_1compression_1gain_1db
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_agc_1enable_1limiter
        (JNIEnv *env, jobject thiz, jboolean enable){
    ApmWrapper *apm = (ApmWrapper*) get_ctx(env, thiz);
...
JNIEXPORT int JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_agc_1enable
(JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_agc_1set_1stream_1analog_1level
(JNIEnv *env, jobject thiz, jint level){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_agc_1stream_1analog_1level
        (JNIEnv *env, jobject thiz){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_vad_1enable
(JNIEnv *env, jobject thiz, jboolean enable){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_vad_1set_1likelihood
...
JNIEXPORT jboolean JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_vad_1stream_1has_1voice
        (JNIEnv *env, jobject thiz){
...
JNIEXPORT jint JNICALL Java_com_huawu_fivesmart_audio_apm_Apm_set_1stream_1delay_1ms
